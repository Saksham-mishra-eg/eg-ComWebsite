                    ...
                    <Col md={12}>
                        <div className={styles.pvcpol_cnt1}>
                            ...
                            <ol className={styles.firlemtul}>
                                <li><a href="https://dashboard2.exportgenius.in/" target="_blank">Login</a> to Export Genius Dashboard</li>
                            ...
                            <p>To avoid getting charged, you need to cancel your free trial at least one day before the trial expires. If you’ve missed cancelling your free trial and have been charged for your subscription, please refer to the <a href="refund_policy.php">Refund Policy</a>.</p>
                        </div>
                        ...
                        <div className={styles.pvcpol_cnt1}>
                            ...
                            <br />
                            <h5>Important Notice</h5>
                            <p>To avoid getting charged for another billing cycle, you need to cancel your plan at least one day before your next scheduled billing date. If you’ve missed cancelling your subscription and have been charged, please refer to the <a href="refund_policy.php">Refund Policy</a>.</p>
                        </div>
                        ...
                        <div className={styles.pvcpol_cnt1}>
                            ...
                            <p>If you have any questions or doubts about the rights and restrictions given above for using our Online Platform and Website, please go through our <a href="/terms-and-conditionsp">Terms &amp; Condition</a> , <a href="/privacy-policy">Privacy Policy</a> &amp; <a href="/refund-policy">Refund Policy</a> or You may contact us or send an email to <a href="mailto:info@exportgenius.in" target="_blank">info@exportgenius.in</a>.</p>
                        </div>
                    </Col>
                </Row>
            </Container>
