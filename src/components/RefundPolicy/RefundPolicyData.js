                ...
                <Row>
                    <Col md={12}>
                        ...
                        <div className={styles.pvcpol_cnt1}>
                            ...
                            <p>To claim your refund, please reach us at <a href="mailto:support@exportgenius.in" target="_blank">support@exportgenius.in</a>, with your details such as your User Id/ Registered Email and Contact Number. Our team will contact you within 2 working days.</p>
                        </div>

                        <div className={styles.pvcpol_cnt1}>
                            <h2>For Additional Information</h2>
                            <p>If you have any questions or doubts about the rights and restrictions given above for using our Online Platform and Website, please go through our <a href="/terms-and-conditions">Terms &amp; Condition</a> , <a href="/privacy-policy">Privacy Policy</a> &amp; <a href="/refund-policy">Refund Policy</a> or You may contact us or send an email to <a href="mailto:info@exportgenius.in" target="_blank">info@exportgenius.in</a>.</p>
                        </div>
                    </Col>
                </Row>
            </Container>
