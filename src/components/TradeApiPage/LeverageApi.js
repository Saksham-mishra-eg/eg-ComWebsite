    ...
    const CompnyLookUPReqSnippet = `
{
   ...
   "filter" : {
    ...
    const CompnyLookUPRespnSnippet = `
{
    "log_id": "kMYnjugsJ2e",
    "total": 11,
    "result": [
...
"filter": {
    ...
    const CompnyPrfAPiRespnSnippet = `
{
"log_id": "E4dricjs7v",
"total": 10,
"result": {
