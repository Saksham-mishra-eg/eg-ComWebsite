                ...
                <Row>
                        ...
                        <div class={styles.OChoices}>
                            <div class={styles.OChoiceGroup}>
                                ...
                                <p><b>11 Countries Detailed Data</b> Argentina, Chile, Colombia,
                                    Ecuador, India, Mexico (Sea Mode)....<a className={styles.viewLLs} href="javascript:void(0)">View All</a> </p>
                            </div>
                            <div class={styles.OChoiceGroup}>
                                <img src="right.png" alt="icon" />
                    ...
                    <div class={styles.OPlan}>
                        ...
                        <div class={styles.OChoices}>
                            <div class={styles.OChoiceGroup}>
                                <img src="right.png" alt="icon" />
                                <p><b>30 Countries Detailed Data</b> Argentina, Bangladesh, Bolivia, Botswana, Chile, Colombia....<a className={styles.viewLLs} href="javascript:void(0)">View All</a> </p>
                            </div>
                            <div class={styles.OChoiceGroup}>
                                <img src="right.png" alt="icon" />
                    ...
                    <div class={styles.OPlan}>
                        ...
                        <div class={styles.OChoices}>
                            <div class={styles.OChoiceGroup}>
                                <img src="right.png" alt="icon" />
                                <p><b>55 Countries Detailed Data</b> Angola, Argentina, Bangladesh, Bolivia, Botswana, Burundi ....<a className={styles.viewLLs} href="javascript:void(0)">View All</a> </p>
                            </div>
                            <div class={styles.OChoiceGroup}>
                                <img src="right.png" alt="icon" />
